...
using ProgrammaticExportSampleAppISV.Helpers;

namespace ProgrammaticExportSampleAppISV.Controllers
{
    [ApiController]
    [Route("[controller]")]
    public class ProgrammaticExportSampleAppISVController : ControllerBase
    {
        private readonly ILogger<ProgrammaticExportSampleAppISVController> _logger;
        private IConfiguration _configuration;
        private TokenGenerator _tokenGenerator;
        private ExportDownloader _exportDownloader;
        private const string _tokenHeaderKey = "X-AadUserTicket";

        public ProgrammaticExportSampleAppISVController(
            ILogger<ProgrammaticExportSampleAppISVController> logger,
